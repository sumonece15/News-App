...
public class TechnologyFragment extends Fragment {
    ...
    Adapter adapter;
    String country = "in";
    private RecyclerView technologyRecView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        technologyRecView = view.findViewById(R.id.technologyRecView);
        modelClassArrayList = new ArrayList<>();
        technologyRecView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter= new Adapter(getContext(), modelClassArrayList);
        technologyRecView.setAdapter(adapter);
