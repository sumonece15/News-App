...
public class ScienceFragment extends Fragment {
    ...
    Adapter adapter;
    String country = "in";
    private RecyclerView scienceRecView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        scienceRecView = view.findViewById(R.id.scienceRecView);
        modelClassArrayList = new ArrayList<>();
        scienceRecView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter= new Adapter(getContext(), modelClassArrayList);
        scienceRecView.setAdapter(adapter);
